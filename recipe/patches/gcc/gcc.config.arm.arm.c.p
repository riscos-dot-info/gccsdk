--- gcc/config/arm/arm.c.orig	2012-09-02 11:53:16.000000000 +0100
+++ gcc/config/arm/arm.c	2012-09-02 11:53:03.000000000 +0100
...
+
   if (NUM_ARG_REGS > nregs
       ...
       && pcum->can_split)
@@ -3130,13 +3202,40 @@ arm_is_longcall_p (rtx sym_ref, int call
 static bool
...
+	 checking is enabled.
+	 This addresses bug#243 - more of a compromise than a fix.  */
+      return false;
+    }
+
...
@@ -3162,6 +3261,26 @@ arm_function_ok_for_sibcall (tree decl,
...
@@ -3205,11 +3324,43 @@ legitimize_pic_address (rtx orig, enum m
 	  subregs = 1;
 	}
...
@@ -3220,12 +3371,14 @@ legitimize_pic_address (rtx orig, enum m
       else
...
@@ -3233,8 +3386,8 @@ legitimize_pic_address (rtx orig, enum m
 	}
...
@@ -3365,6 +3518,18 @@ arm_load_pic_register (unsigned long sav
...
@@ -3375,7 +3540,10 @@ arm_load_pic_register (unsigned long sav
...
@@ -3386,9 +3554,24 @@ arm_load_pic_register (unsigned long sav
...
+	}
     ...
     {
@@ -3410,6 +3593,7 @@ arm_load_pic_register (unsigned long sav
...
@@ -9205,7 +9389,7 @@ arm_compute_save_reg0_reg12_mask (void)
...
@@ -9215,7 +9399,8 @@ arm_compute_save_reg0_reg12_mask (void)
       if (flag_pic
...
@@ -9251,7 +9436,7 @@ arm_compute_save_reg_mask (void)
...
+  if (arm_apcs_frame_needed ())
     save_reg_mask |=
       ...
       | (1 << IP_REGNUM)
@@ -9335,7 +9520,7 @@ thumb_compute_save_reg_mask (void)
...
@@ -9471,7 +9656,7 @@ output_return_instruction (rtx operand,
...
@@ -9504,9 +9689,18 @@ output_return_instruction (rtx operand,
...
@@ -9693,12 +9887,13 @@ arm_output_function_prologue (FILE *f, H
...
@@ -9770,7 +9965,7 @@ arm_output_epilogue (rtx sibling)
...
@@ -9894,20 +10089,27 @@ arm_output_epilogue (rtx sibling)
       else
...
@@ -9917,12 +10119,21 @@ arm_output_epilogue (rtx sibling)
   else
     {
...
+	}
 	...
 	{
@@ -10099,8 +10310,12 @@ arm_output_function_epilogue (FILE *file
...
+		  || arm_apcs_frame_needed ());
       ...
       after_arm_reorg = 0;
@@ -10318,6 +10533,47 @@ thumb_force_lr_save (void)
 }
...
@@ -10377,7 +10633,6 @@ arm_get_frame_offsets (void)
...
@@ -10396,14 +10651,14 @@ arm_get_frame_offsets (void)
...
+  offsets->frame = offsets->saved_args + (arm_apcs_frame_needed () ? 4 : 0);
   ...
   if (TARGET_ARM)
     {
@@ -10450,7 +10705,7 @@ arm_get_frame_offsets (void)
...
+  if (leaf && offsets->frame_size == 0 && arm_abi != ARM_ABI_APCS32)
     {
       ...
       return offsets;
@@ -10461,7 +10716,10 @@ arm_get_frame_offsets (void)
...
@@ -10487,6 +10745,29 @@ arm_compute_initial_elimination_offset (
...
@@ -10510,7 +10791,7 @@ arm_compute_initial_elimination_offset (
...
@@ -10556,15 +10837,101 @@ arm_compute_initial_elimination_offset (
     }
 }
...
+  rtx ip_rtx, fp_rtx;
   ...
   unsigned long func_type;
   int fp_offset = 0;
@@ -10579,6 +10946,15 @@ arm_expand_prologue (void)
...
@@ -10586,8 +10962,9 @@ arm_expand_prologue (void)
...
+  if (arm_apcs_frame_needed ())
     {
       if (IS_INTERRUPT (func_type))
 	{
@@ -10707,7 +11084,7 @@ arm_expand_prologue (void)
...
+      && ! arm_apcs_frame_needed ())
     emit_insn (gen_rtx_SET (SImode,
 			    ...
 			    gen_rtx_PLUS (SImode,
@@ -10808,13 +11185,67 @@ arm_expand_prologue (void)
 	}
     }
...
@@ -10823,8 +11254,11 @@ arm_expand_prologue (void)
...
@@ -10834,18 +11268,14 @@ arm_expand_prologue (void)
 	}
     }
...
+				    GEN_INT (frame_size)));
 	...
 	{
 	  last = last ? NEXT_INSN (last) : get_insns ();
@@ -10856,13 +11286,27 @@ arm_expand_prologue (void)
...
@@ -11260,14 +11704,20 @@ arm_assemble_integer (rtx x, unsigned in
...
+            }
       ...
       fputc ('\n', asm_out_file);
       return true;
@@ -11311,6 +11761,9 @@ arm_assemble_integer (rtx x, unsigned in
 static void
...
+#else
   if (!TARGET_AAPCS_BASED)
     {
       default_named_section_asm_out_constructor (symbol, priority);
@@ -11323,6 +11776,7 @@ arm_elf_asm_constructor (rtx symbol, int
...
+#endif
 ...
 #endif
 
@@ -11955,7 +12409,7 @@ arm_debugger_arg_offset (int value, rtx
...
@@ -13511,17 +13965,33 @@ arm_init_machine_status (void)
 #if ARM_FT_UNKNOWN != 0
...
@@ -13627,7 +14097,7 @@ thumb_expand_prologue (void)
   if (flag_pic)
...
@@ -13661,7 +14131,7 @@ thumb_expand_prologue (void)
 	     it now.  */
...
@@ -13719,7 +14189,7 @@ thumb_expand_prologue (void)
 	}
     }
...
@@ -13776,7 +14246,7 @@ thumb_expand_epilogue (void)
   offsets = arm_get_frame_offsets ();
...
@@ -15065,7 +15535,7 @@ arm_set_return_address (rtx source, rtx
...
+      if (arm_apcs_frame_needed ())
 	...
 	{
@@ -15108,7 +15578,7 @@ thumb_set_return_address (rtx source, rt
       offsets = arm_get_frame_offsets ();
...
@@ -15165,13 +15635,102 @@ arm_shift_truncation_mask (enum machine_
...
@@ -15179,7 +15738,10 @@ arm_dbx_register_number (unsigned int re
